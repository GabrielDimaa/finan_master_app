...
final class DependencyInjection {
  ...
  Future<void> setup() async {
    ...
    getIt.registerFactory<IExpenseRepository>(() => ExpenseRepository(expenseLocalDataSource: getIt.get<IExpenseLocalDataSource>(), eventNotifier: getIt.get<EventNotifier>()));
    ...
    getIt.registerFactory<IExpenseDelete>(() => ExpenseDelete(repository: getIt.get<IExpenseRepository>(), statementRepository: getIt.get<IStatementRepository>(), localDBTransactionRepository: getIt.get<ILocalDBTransactionRepository>()));
