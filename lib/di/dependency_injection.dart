...
final class DependencyInjection {
  ...
  Future<void> setup() async {
    ...
    getIt.registerFactory<ICreditCardTransactionDelete>(() => CreditCardTransactionDelete(repository: getIt.get<ICreditCardTransactionRepository>(), creditCardBillRepository: getIt.get<ICreditCardBillRepository>(), expenseRepository: getIt.get<IExpenseRepository>(), statementRepository: getIt.get<IStatementRepository>(), localDBTransactionRepository: getIt.get<ILocalDBTransactionRepository>()));
