...
class LoginNotifier extends ValueNotifier<LoginState> {
  ...
  bool get isLoading => value is LoggingState;

  Future<void> login() async {
    try {
      value = value.setLogging();

      await _loginAuth.loginWithEmailAndPassword(value.loginEntity);
    } catch (e) {
  ...
  Future<void> loginWithGoogle() async {
    try {
      ...
      await _loginAuth.loginWithGoogle();
    } catch (e) {
      value = value.setError(e.toString());
    }
  }
