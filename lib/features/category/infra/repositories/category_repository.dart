...
class CategoryRepository implements ICategoryRepository {
  ...
  @override
  Future<Result<List<CategoryEntity>, BaseException>> findAll() async {
  ...
  @override
  Future<Result<CategoryEntity, BaseException>> findById(String id) async {
    final CategoryModel? category = await _dataSource.findById(id);

    if (category == null) return Result.failure(NotFoundException(R.strings.categoryNotFound, null));
  ...
  @override
  Future<Result<dynamic, BaseException>> delete(CategoryEntity entity) async {
